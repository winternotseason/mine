...
const RegionFilter = ({ isRegionOpen, setIsRegionOpen }: Props) => {
  ...
  return (
    <>
      {isRegionOpen && (
        <div className="w-full h-full absolute top-0 left-0 bg-black/40 z-50" />
      )}
      <div
        className={`fixed w-3/4 md:w-1/3 z-50 top-0 -left-5 h-full bg-white  transition-transform duration-300 ease-in-out overflow-auto ${
